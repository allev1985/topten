...
- TypeScript 5 / Node 20 + Next.js 15 (App Router), Tailwind CSS v4, shadcn/ui (new-york), Google Fonts (DM Serif Display, DM Sans) (001-brand-styling)
...
## Recent Changes
- 001-brand-styling: Added TypeScript 5 / Node 20 + Next.js 15 (App Router), Tailwind CSS v4, shadcn/ui (new-york), Google Fonts (DM Serif Display, DM Sans)
